...
const COPY = {
  EN: {
    ...
    waitingForConnection: 'Your work stays on this phone until you reconnect.',
    start: 'Start',
    ...
    nothingWaiting: "Nothing waiting. You're all caught up.",
    tapSyncNow: 'Tap Sync now to upload.',
    syncNow: 'Sync now',
    syncing: 'Syncing…',
    retry: 'Retry',
    retryCount: 'Retry',
    queueTapToRetry: 'Tap to retry',
    ...
    edgeBlockedPrimary: 'Got it',
    edgeBlockedSecondary: 'Show downloaded modules',
    ...
    edgeUploadPrimary: 'Tap to retry',
    edgeUploadSecondary: 'Keep in queue',
    edgeIncompleteTitle: 'Something needs your attention',
    edgeIncompleteBody: 'Before we save this evidence, please fix:',
    edgeIncompleteItem1: 'SGM 2.0 domain is missing — every evidence item needs one.',
    ...
    edgeIncompletePrimary: 'Fix now',
    edgeIncompleteSecondary: 'Save as draft',
    ...
    edgeStoragePrimary: 'Sync now',
    edgeStorageSecondary: 'Manage downloads',

    // Data-use receipt
    dataUseReceipt: 'Data-use receipt',
    whatWasUploaded: 'What was uploaded',
    whatWasUploadedBody: 'photo (faces blurred), reflection, module link, SGM domain, date',
    when: 'When',
    whenBody: 'last sync',
    whichDomain: 'Which domain',
    whoCanAccess: 'Who can access',
    whoCanAccessBody: 'you (full), school leader (counts), PPD (aggregated). Not used for punishment.',
  },
  BM: {
    home: 'Utama',
    learn: 'Belajar',
    ...
    waitingForConnection: 'Kerja anda kekal dalam telefon sehingga anda sambung semula.',
    start: 'Mula',
    ...
    nothingWaiting: 'Tiada yang menunggu. Semuanya selesai.',
    tapSyncNow: 'Ketik Sync sekarang untuk muat naik.',
    syncNow: 'Sync sekarang',
    syncing: 'Sedang sync…',
    retry: 'Cuba lagi',
    retryCount: 'Cuba',
    queueTapToRetry: 'Ketik untuk cuba lagi',
    queueEmpty: 'Baris gilir kosong',
    ...
    edgeBlockedPrimary: 'Faham',
    edgeBlockedSecondary: 'Tunjukkan modul yang dimuat turun',
    ...
    edgeUploadPrimary: 'Ketik untuk cuba lagi',
    edgeUploadSecondary: 'Kekal dalam baris gilir',
    ...
    edgeIncompletePrimary: 'Betulkan sekarang',
    edgeIncompleteSecondary: 'Simpan sebagai draf',
    ...
    edgeStoragePrimary: 'Sync sekarang',
    edgeStorageSecondary: 'Urus muat turun',

    // Data-use receipt
    dataUseReceipt: 'Resit penggunaan data',
    whatWasUploaded: 'Apa yang dimuat naik',
    whatWasUploadedBody: 'foto (wajah dikaburkan), refleksi, pautan modul, domain SGM, tarikh',
    when: 'Bila',
    whenBody: 'sync terakhir',
    whichDomain: 'Domain mana',
    whoCanAccess: 'Siapa boleh akses',
    whoCanAccessBody: 'anda (penuh), guru besar (kiraan), PPD (agregat). Tidak digunakan untuk hukuman.',
  },
};
